...
import com.example.android.bloodbank.data.model.category.CategoryPagination;
import com.example.android.bloodbank.data.model.generalResponse.GeneralResponseData;

import java.util.ArrayList;
import java.util.List;

public class SpinnerAdapterCateg extends BaseAdapter {
    private Context context;
    private LayoutInflater inflater;
    public List<CategoryPagination> list = new ArrayList<>();
    public int selectedId = 0;

    public SpinnerAdapterCateg(Context applicationContext) {
        this.context = applicationContext;
        inflater = (LayoutInflater.from(applicationContext));
    }

    public void setData(List<CategoryPagination> list, String hint) {
        this.list = new ArrayList<>();
        this.list.add(new CategoryPagination(0, hint));
