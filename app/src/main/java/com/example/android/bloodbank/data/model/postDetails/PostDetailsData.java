...
package com.example.android.bloodbank.data.model.postDetails;
...
public class PostDetailsData {
    ...
    @Expose
    private PostDetailsCategory category;
    ...
    public PostDetailsCategory getCategory() {
        return category;
    }

    public void setCategory(PostDetailsCategory category) {
